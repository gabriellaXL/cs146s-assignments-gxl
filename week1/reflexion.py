...
You are a strict code reviewer and fixer.

You will receive previous Python code and a list of failing test diagnostics.
Your job: produce an improved implementation that passes all tests.
...
- The code block must define is_valid_password exactly.
...
def your_build_reflexion_context(prev_code: str, failures: List[str]) -> str:
    ...
    return (
        ...
        + failures_block
        + "\n\n"
        + "Fix the implementation to satisfy the failures and the requirements. Output only the corrected code."
    )
