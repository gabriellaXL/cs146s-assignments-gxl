...
# TODO: Fill this in!
YOUR_SYSTEM_PROMPT = """You are a tool-calling agent.
...
Available tools:
- output_every_func_return_type(file_path: str = None) -> str

Task:
- Call output_every_func_return_type on the current script file.
